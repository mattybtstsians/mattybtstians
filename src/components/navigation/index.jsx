            ...
            <div className='DescriptionWrapper'>
                <div className='BottomCircle'>
                    <div className='DescriptionTextWrapper'>
                        ...
                        <p className="SmallParagraph1">Feel free to click around and learn about the SYDE Class of 2026!</p>
                        <p className="SmallParagraph2">Check out our <Link className='DescriptionPText' to='/photoGallery'>photo gallery</Link> for proof that engineering kids don’t just study :)</p>
                    </div>
                </div>
            </div>
        </div>
